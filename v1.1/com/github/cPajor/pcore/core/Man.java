...
import com.github.cPajor.pcore.commands.admin.RynekCommand;
...
import com.github.cPajor.pcore.dzialka.DzialkaCommand;
import com.github.cPajor.pcore.dzialka.DzialkaListeners;
import com.github.cPajor.pcore.hook.placeholderapi.PlaceholderHook;
...
import com.github.cPajor.pcore.listeners.player.PackListener;
...
public class Man {
	...
	private static void setupSettings() { 
		...
		WorldCreator wc = new WorldCreator("spawnc");
		wc.type(WorldType.AMPLIFIED);
		if (Bukkit.getWorld("spawnc") == null) Bukkit.createWorld(wc);
		Bukkit.getServer().getWorld("spawnc").setSpawnLocation(SpawnCommand.getSpawn());
	...
	private static void setupTasks() {
		...
		//new DzialkaSys().runTaskTimer(CReg.getPlugin(), 10, 10);
	}
	...
	private static void registerListener() {
		...
		Bukkit.getPluginManager().registerEvents(new DzialkaListeners(), CReg.getPlugin());
		Bukkit.getPluginManager().registerEvents(new PackListener(), CReg.getPlugin());
	...
	private static void registerCommands() { 
		...
		CmdM.register(new DzialkaCommand("dzialka"));
		CmdM.register(new DzialkaCommand("d"));
		//CmdM.register(new SklepCommand());
	}
	
	public static void initTab() {
		/*BungeeTabListPlusBukkitAPI.registerVariable(Main.getPlugin(), new PointsVariable("points"));
		BungeeTabListPlusBukkitAPI.registerVariable(Main.getPlugin(), new PrestizVariable("fall"));
		BungeeTabListPlusBukkitAPI.registerVariable(Main.getPlugin(), new GuildVariable("guild"));
		BungeeTabListPlusBukkitAPI.registerVariable(Main.getPlugin(), new GAllVariable("gall"));
		BungeeTabListPlusBukkitAPI.registerVariable(Main.getPlugin(), new GOnlineVariable("gonline"));
		BungeeTabListPlusBukkitAPI.registerVariable(Main.getPlugin(), new GLiderVariable("glider"));
		BungeeTabListPlusBukkitAPI.registerVariable(Main.getPlugin(), new Depo1Variable("depo1"));
		BungeeTabListPlusBukkitAPI.registerVariable(Main.getPlugin(), new Depo2Variable("depo2"));
		BungeeTabListPlusBukkitAPI.registerVariable(Main.getPlugin(), new Depo3Variable("depo3"));
		BungeeTabListPlusBukkitAPI.registerVariable(Main.getPlugin(), new Depo4Variable("depo4"));
		for (int i = 1; i < 21; i++) { 
			BungeeTabListPlusBukkitAPI.registerVariable(Main.getPlugin(), new GMembersVariable("gmember" + i));
		}*/
	}
	
	public static void unTab() {
		/*BungeeTabListPlusBukkitAPI.unregisterVariable(new PointsVariable("points"));
		BungeeTabListPlusBukkitAPI.unregisterVariable(new PrestizVariable("fall"));
		BungeeTabListPlusBukkitAPI.unregisterVariable(new GuildVariable("guild"));
		BungeeTabListPlusBukkitAPI.unregisterVariable(new GAllVariable("gall"));
		BungeeTabListPlusBukkitAPI.unregisterVariable(new GOnlineVariable("gonline"));
		BungeeTabListPlusBukkitAPI.unregisterVariable(new GLiderVariable("glider"));
		BungeeTabListPlusBukkitAPI.unregisterVariable(new Depo1Variable("depo1"));
		BungeeTabListPlusBukkitAPI.unregisterVariable(new Depo2Variable("depo2"));
		BungeeTabListPlusBukkitAPI.unregisterVariable(new Depo3Variable("depo3"));
		BungeeTabListPlusBukkitAPI.unregisterVariable(new Depo4Variable("depo4"));
		for (int i = 1; i < 21; i++) { 
			BungeeTabListPlusBukkitAPI.unregisterVariable(new GMembersVariable("gmember" + i));
		}*/
	}
