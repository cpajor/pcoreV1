...
public class LocationUtil {
	...
	public static Location LocationFromString( String s) {
         String[] ss = s.split("_");
         Location l = new Location((World)Bukkit.getWorlds().get(0), 0.0, 0.0, 0.0, 0.0f, 0.0f);
    ...
    public static String LocationToString( Location l) {
        return String.valueOf(l.getWorld().getName()) + "_" + l.getX() + "_" + l.getY() + "_" + l.getZ() + "_" + l.getYaw() + "_" + l.getPitch();
    }
